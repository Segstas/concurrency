...
public class TokenNodeConcurrentLinkedQueue extends ThroughputChecker implements TokenNode {
    ...
    public TokenNodeConcurrentLinkedQueue(int index, TokenNode next) {
        this.index = index;
        this.next = next;
    }
