...
public class Main {
    public static void main(String[] args) {
        TokenNode node0 = new TokenNode(0);
        TokenNode node1 = new TokenNode(1, node0);
        TokenNode node2 = new TokenNode(2, node1);
        TokenNode node3 = new TokenNode(3, node2);
        TokenNode node4 = new TokenNode(4, node3);
        node0.setNext(node4);
